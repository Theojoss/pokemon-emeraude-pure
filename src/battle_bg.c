...
static const struct WindowTemplate sStandardBattleWindowTemplates[] =
{
    ...
    [B_WIN_YESNO] = {
        .bg = 0,
        .tilemapLeft = 25, //!< French Difference
        .tilemapTop = 9,
        .width = 4, //!< French Difference
        .height = 4,
        .paletteNum = 5,
        .baseBlock = 0x0100,
    },
...
static const struct WindowTemplate sBattleArenaWindowTemplates[] =
{
    ...
    [ARENA_WIN_SKILL] = {
        .bg = 0,
        .tilemapLeft = 11, //!< French Difference
        .tilemapTop = 6,
        .width = 8, //!< French Difference
        .height = 2,
        .paletteNum = 5,
        .baseBlock = 0x0130,
    },
    [ARENA_WIN_BODY] = {
        ...
        .height = 2,
        .paletteNum = 5,
        .baseBlock = 0x0140, //!< French Difference
    },
    [ARENA_WIN_JUDGMENT_TITLE] = {
        ...
        .height = 2,
        .paletteNum = 5,
        .baseBlock = 0x014C, //!< French Difference
    },
...
static u8 GetBattleEnvironmentOverride(void)
{
    ...
    else if (gBattleTypeFlags & BATTLE_TYPE_TRAINER)
    {
        ...
        if (TRAINER_BATTLE_PARAM.opponentA == TRAINER_THEOJOSS)
            return BATTLE_ENVIRONMENT_MOUNTAIN2;
