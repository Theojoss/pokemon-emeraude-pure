...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_HIKER] = { _("MONTAGNARD"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_ULTRA : BALL_POKE },
    [TRAINER_CLASS_TEAM_AQUA] = { _("TEAM AQUA") },
    [TRAINER_CLASS_PKMN_BREEDER] = { _("ELEVEUR"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_HEAL : BALL_FRIEND },
    [TRAINER_CLASS_COOLTRAINER] = { _("TOPDRESSEUR"), 12, BALL_ULTRA },
    [TRAINER_CLASS_BIRD_KEEPER] = { _("ORNITHOLOGUE"), 8 },
    [TRAINER_CLASS_COLLECTOR] = { _("COLLEC"), 15, BALL_PREMIER },
    [TRAINER_CLASS_SWIMMER_M] = { _("NAGEUR"), 2, BALL_DIVE },
    ...
    [TRAINER_CLASS_AQUA_LEADER] = { _("LEADER AQUA"), 20, BALL_MASTER },
    [TRAINER_CLASS_HEX_MANIAC] = { _("MYSTIMANIAC"), 6 },
    [TRAINER_CLASS_AROMA_LADY] = { _("AROMA"), 10 },
    [TRAINER_CLASS_RUIN_MANIAC] = { _("RUINEMANIAC"), 15 },
    [TRAINER_CLASS_INTERVIEWER] = { _("JOURNALISTES"), 12 },
    [TRAINER_CLASS_TUBER_F] = { _("FLOTTEUR"), 1 },
    [TRAINER_CLASS_TUBER_M] = { _("FLOTTEUR"), 1 },
    [TRAINER_CLASS_LADY] = { _("MADEMOISELLE"), 50 },
    [TRAINER_CLASS_BEAUTY] = { _("CANON"), 20, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_GREAT : BALL_POKE },
    [TRAINER_CLASS_RICH_BOY] = { _("RICHARD"), 50 },
    [TRAINER_CLASS_POKEMANIAC] = { _("POKéMANIAC"), 15 },
    [TRAINER_CLASS_GUITARIST] = { _("GUITARISTE"), 8 },
    [TRAINER_CLASS_KINDLER] = { _("SALTIMBANQUE"), 8 },
    [TRAINER_CLASS_CAMPER] = { _("CAMPEUR"), 4 },
    [TRAINER_CLASS_PICNICKER] = { _("PIQUE-NIQUE"), 4 },
    [TRAINER_CLASS_BUG_MANIAC] = { _("ENTOMOMANIAC"), 15 },
    [TRAINER_CLASS_PSYCHIC] = { _("KINESISTE"), 6 },
    [TRAINER_CLASS_GENTLEMAN] = { _("GENTLEMAN"), 20, BALL_LUXURY },
    [TRAINER_CLASS_ELITE_FOUR] = { _("CONSEIL 4"), 25, BALL_ULTRA },
    [TRAINER_CLASS_LEADER] = { _("CHAMPION"), 25, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_ULTRA : BALL_POKE },
    [TRAINER_CLASS_SCHOOL_KID] = { _("ELEVE") },
    [TRAINER_CLASS_SR_AND_JR] = { _("SR. ET JR."), 4 },
    [TRAINER_CLASS_WINSTRATE] = { _("STRATEGE"), 10 },
    [TRAINER_CLASS_POKEFAN] = { _("POKéFAN"), 20 },
    [TRAINER_CLASS_YOUNGSTER] = { _("GAMIN"), 4 },
    [TRAINER_CLASS_CHAMPION] = { _("MAITRE"), 50, BALL_ULTRA },
    [TRAINER_CLASS_FISHERMAN] = { _("PECHEUR"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_DIVE : BALL_LURE },
    [TRAINER_CLASS_TRIATHLETE] = { _("TRIATHLETE"), 10 },
    [TRAINER_CLASS_DRAGON_TAMER] = { _("DRACOLOGUE"), 12 },
    [TRAINER_CLASS_NINJA_BOY] = { _("NINJA FAN"), 3 },
    [TRAINER_CLASS_BATTLE_GIRL] = { _("COMBATTANTE"), 6 },
    [TRAINER_CLASS_PARASOL_LADY] = { _("SŒUR PARASOL"), 10 },
    [TRAINER_CLASS_SWIMMER_F] = { _("NAGEUSE"), 2, BALL_DIVE },
    [TRAINER_CLASS_TWINS] = { _("JUMELLES"), 3 },
    [TRAINER_CLASS_SAILOR] = { _("MARIN"), 8 },
    [TRAINER_CLASS_COOLTRAINER_2] = { _("TOPDRESSEUR"), 5, BALL_ULTRA },
    [TRAINER_CLASS_MAGMA_ADMIN] = { _("ADMIN MAGMA"), 10 },
    [TRAINER_CLASS_RIVAL] = { _("DRESSEUR"), 15 },
    [TRAINER_CLASS_BUG_CATCHER] = { _("SCOUT"), 4 },
    [TRAINER_CLASS_PKMN_RANGER] = { _("{PKMN} RANGER"), 12 },
    [TRAINER_CLASS_MAGMA_LEADER] = { _("LEADER MAGMA"), 20, BALL_MASTER },
    [TRAINER_CLASS_LASS] = { _("FILLETTE"), 4 },
    [TRAINER_CLASS_YOUNG_COUPLE] = { _("JEUNE COUPLE"), 8 },
    [TRAINER_CLASS_OLD_COUPLE] = { _("VIEUX COUPLE"), 10 },
    [TRAINER_CLASS_SIS_AND_BRO] = { _("FRERE & SŒUR"), 3 },
    [TRAINER_CLASS_SALON_MAIDEN] = { _("AS DU SALON"), 5, BALL_ULTRA },
    ...
    [TRAINER_CLASS_YOUNGSTER_FRLG] =       { _("GAMIN"), 4 },
    [TRAINER_CLASS_BUG_CATCHER_FRLG] =     { _("SCOUT"), 3 },
    [TRAINER_CLASS_LASS_FRLG] =            { _("FILLETTE"), 4 },
    [TRAINER_CLASS_SAILOR_FRLG] =          { _("MARIN"), 8 },
    [TRAINER_CLASS_CAMPER_FRLG] =          { _("CAMPEUR"), 5 },
    [TRAINER_CLASS_PICNICKER_FRLG] =       { _("PIQUE-NIQUE"), 5 },
    [TRAINER_CLASS_POKEMANIAC_FRLG] =      { _("POKéMANIAC"), 12 },
    [TRAINER_CLASS_SUPER_NERD_FRLG] =      { _("INTELLO"), 6 },
    [TRAINER_CLASS_HIKER_FRLG] =           { _("MONTAGNARD"), 9 },
    [TRAINER_CLASS_BIKER_FRLG] =           { _("MOTARD"), 5 },
    [TRAINER_CLASS_BURGLAR_FRLG] =         { _("PILLARD"), 22 },
    [TRAINER_CLASS_ENGINEER_FRLG] =        { _("MECANO"), 12 },
    [TRAINER_CLASS_FISHERMAN_FRLG] =       { _("PECHEUR"), 9, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_DIVE : BALL_LURE },
    [TRAINER_CLASS_SWIMMER_M_FRLG] =       { _("NAGEUR"), 1 },
    [TRAINER_CLASS_CUE_BALL_FRLG] =        { _("LOUBARD"), 6 },
    [TRAINER_CLASS_GAMER_FRLG] =           { _("CROUPIER"), 18 },
    [TRAINER_CLASS_BEAUTY_FRLG] =          { _("CANON"), 18 },
    [TRAINER_CLASS_SWIMMER_F_FRLG] =       { _("NAGEUSE"), 1, BALL_DIVE },
    [TRAINER_CLASS_PSYCHIC_FRLG] =         { _("KINESISTE"), 5 },
    [TRAINER_CLASS_ROCKER_FRLG] =          { _("ROCKER"), 6 },
    [TRAINER_CLASS_JUGGLER_FRLG] =         { _("JONGLEUR"), 10 },
    [TRAINER_CLASS_TAMER_FRLG] =           { _("DOMPTEUR"), 10 },
    [TRAINER_CLASS_BIRD_KEEPER_FRLG] =     { _("ORNITHOLOGUE"), 6 },
    [TRAINER_CLASS_BLACK_BELT_FRLG] =      { _("KARATEKA"), 6, BALL_ULTRA },
    [TRAINER_CLASS_RIVAL_EARLY_FRLG] =     { _("RIVAL"), 4 },
    [TRAINER_CLASS_SCIENTIST_FRLG] =       { _("SCIENTIFIQUE"), 12 },
    [TRAINER_CLASS_BOSS_FRLG] =            { _("BOSS"), 25 },
    [TRAINER_CLASS_LEADER_FRLG] =          { _("CHAMPION"), 25 },
    [TRAINER_CLASS_TEAM_ROCKET_FRLG] =     { _("TEAM ROCKET"), 8 },
    [TRAINER_CLASS_COOLTRAINER_FRLG] =     { _("TOPDRESSEUR"), 9, BALL_ULTRA },
    [TRAINER_CLASS_ELITE_FOUR_FRLG] =      { _("CONSEIL 4"), 25, BALL_ULTRA },
    [TRAINER_CLASS_GENTLEMAN_FRLG] =       { _("GENTLEMAN"), 18, BALL_LUXURY },
    [TRAINER_CLASS_RIVAL_LATE_FRLG] =      { _("RIVAL"), 9 },
    [TRAINER_CLASS_CHAMPION_FRLG] =        { _("MAITRE"), 25 },
    [TRAINER_CLASS_CHANNELER_FRLG] =       { _("EXORCISTE"), 8 },
    [TRAINER_CLASS_TWINS_FRLG] =           { _("JUMELLES"), 3 },
    [TRAINER_CLASS_COOL_COUPLE_FRLG] =     { _("COUPLE COOL"), 6 },
    [TRAINER_CLASS_YOUNG_COUPLE_FRLG] =    { _("JEUNE COUPLE"), 7 },
    [TRAINER_CLASS_CRUSH_KIN_FRLG] =       { _("DUO BASTON"), 6 },
    [TRAINER_CLASS_SIS_AND_BRO_FRLG] =     { _("FRERE & SŒUR"), 1 },
    [TRAINER_CLASS_PKMN_PROF_FRLG] =       { _("PROF. {PKMN}"), 25 },
    [TRAINER_CLASS_PLAYER_FRLG] =          { _("JOUEUR"), 1 },
    [TRAINER_CLASS_CRUSH_GIRL_FRLG] =      { _("FILLE BASTON"), 6 },
    [TRAINER_CLASS_TUBER_FRLG] =           { _("FLOTTEUR"), 1 },
    [TRAINER_CLASS_PKMN_BREEDER_FRLG] =    { _("ELEVEUR"), 7, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_HEAL : BALL_FRIEND },
    [TRAINER_CLASS_PKMN_RANGER_FRLG] =     { _("{PKMN} RANGER"), 9 },
    [TRAINER_CLASS_AROMA_LADY_FRLG] =      { _("AROMA"), 7 },
    [TRAINER_CLASS_RUIN_MANIAC_FRLG] =     { _("RUINEMANIAC"), 12 },
    [TRAINER_CLASS_LADY_FRLG] =            { _("MADEMOISELLE"), 50 },
    [TRAINER_CLASS_PAINTER_FRLG] =         { _("PEINTRE"), 4 },
};
