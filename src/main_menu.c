...
static u32 InitMainMenu(bool8 returningFromOptionsMenu)
{
    ...
    ResetPaletteFade();
    //LoadPalette(sMainMenuBgPal, BG_PLTT_ID(0), PLTT_SIZE_4BPP); // new main menu UI draws its own background
...
static void Task_DisplayMainMenu(u8 taskId)
{
    ...
    gTasks[taskId].func = Task_OpenMainMenu; // hand off to the new main menu UI
    return;
