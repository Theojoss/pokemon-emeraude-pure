...
#define B_FLAG_FOLLOWERS_DISABLED      FLAG_FOLLOWER_DISABLED // Enables / Disables followers by using a flag. Helpful to disable followers for a period of time.
...
#define OW_ALTERED_TIME_RATIO           30   // In GEN_8_PLA, the time in game moves forward 60 seconds for every second in the RTC. In GEN_9, it is 20 seconds. TIME_DEBUG is 1:1, and meant for debugging purposes. Any other numeric value is used directly as the ratio. This has no effect if OW_USE_FAKE_RTC is FALSE.
