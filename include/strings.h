...
extern const u8 gText_Birch_ShinyRateChoice[];
...
extern const u8 gText_RecifDesLegendes[];
...
extern const u8 gText_NamingScreenKeyboard_MNOPQRS[];
extern const u8 gText_NamingScreenKeyboard_TUVWXYZ[];
extern const u8 gText_NamingScreenKeyboardCode_ABCDEFGH[];
extern const u8 gText_NamingScreenKeyboardCode_IJKLMNOP[];
extern const u8 gText_NamingScreenKeyboardCode_QRSTUVWX[];
extern const u8 gText_NamingScreenKeyboardCode_YZ123[];
