...
#define FLAG_FOLLOWER_DISABLED    0x40 // Set when the player disables the Pokémon follower via the options menu
...
#define FLAG_DEFEATED_THEOJOSS                                      0x4F9
#define FLAG_RECEIVED_THEOJOSS_EGG                                  0x4FA
...
#define FLAG_RECEIVED_OUTFIT_BOX                                    0x4FF
...
#define FLAG_ITEM_MAGMA_HIDEOUT_4F_OUTFIT           (SYSTEM_FLAGS + 0xB6)
