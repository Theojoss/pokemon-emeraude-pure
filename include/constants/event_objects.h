...
enum
{
    ...
    OBJ_EVENT_GFX_JOHTO_F_NORMAL,
    OBJ_EVENT_GFX_JOHTO_F_MACH_BIKE,
    OBJ_EVENT_GFX_JOHTO_F_ACRO_BIKE,
    OBJ_EVENT_GFX_JOHTO_F_SURFING,
    OBJ_EVENT_GFX_JOHTO_F_UNDERWATER,
    OBJ_EVENT_GFX_JOHTO_F_FIELD_MOVE,
    OBJ_EVENT_GFX_JOHTO_F_FISHING,
    OBJ_EVENT_GFX_JOHTO_F_WATERING,
    OBJ_EVENT_GFX_JOHTO_F_DECORATING,

    // Hoenn outfit (costume system)
    OBJ_EVENT_GFX_HOENN_NORMAL,
    OBJ_EVENT_GFX_HOENN_MACH_BIKE,
    OBJ_EVENT_GFX_HOENN_ACRO_BIKE,
    OBJ_EVENT_GFX_HOENN_SURFING,
    OBJ_EVENT_GFX_HOENN_FIELD_MOVE,
    OBJ_EVENT_GFX_HOENN_FISHING,
    OBJ_EVENT_GFX_HOENN_WATERING,
    OBJ_EVENT_GFX_HOENN_DECORATING,

    // Kanto outfit, male (costume system)
    OBJ_EVENT_GFX_KANTO_M_NORMAL,
    OBJ_EVENT_GFX_KANTO_M_MACH_BIKE,
    OBJ_EVENT_GFX_KANTO_M_ACRO_BIKE,
    OBJ_EVENT_GFX_KANTO_M_SURFING,
    OBJ_EVENT_GFX_KANTO_M_UNDERWATER,
    OBJ_EVENT_GFX_KANTO_M_FIELD_MOVE,
    OBJ_EVENT_GFX_KANTO_M_FISHING,
    OBJ_EVENT_GFX_KANTO_M_WATERING,
    OBJ_EVENT_GFX_KANTO_M_DECORATING,

    // Kanto outfit, female (costume system)
    OBJ_EVENT_GFX_KANTO_F_NORMAL,
    OBJ_EVENT_GFX_KANTO_F_MACH_BIKE,
    OBJ_EVENT_GFX_KANTO_F_ACRO_BIKE,
    OBJ_EVENT_GFX_KANTO_F_SURFING,
    OBJ_EVENT_GFX_KANTO_F_UNDERWATER,
    OBJ_EVENT_GFX_KANTO_F_FIELD_MOVE,
    OBJ_EVENT_GFX_KANTO_F_FISHING,
    OBJ_EVENT_GFX_KANTO_F_WATERING,
    OBJ_EVENT_GFX_KANTO_F_DECORATING,

    // Sinnoh outfit (costume system)
    OBJ_EVENT_GFX_SINNOH_NORMAL,
    OBJ_EVENT_GFX_SINNOH_MACH_BIKE,
    OBJ_EVENT_GFX_SINNOH_ACRO_BIKE,
    OBJ_EVENT_GFX_SINNOH_SURFING,
    OBJ_EVENT_GFX_SINNOH_UNDERWATER,
    OBJ_EVENT_GFX_SINNOH_FIELD_MOVE,
    OBJ_EVENT_GFX_SINNOH_FISHING,
    OBJ_EVENT_GFX_SINNOH_WATERING,
    OBJ_EVENT_GFX_SINNOH_DECORATING,

    // Sinnoh outfit, female (costume system)
    OBJ_EVENT_GFX_SINNOH_F_NORMAL,
    OBJ_EVENT_GFX_SINNOH_F_MACH_BIKE,
    OBJ_EVENT_GFX_SINNOH_F_SURFING,
    OBJ_EVENT_GFX_SINNOH_F_FIELD_MOVE,
    OBJ_EVENT_GFX_SINNOH_F_FISHING,
    OBJ_EVENT_GFX_SINNOH_F_WATERING,
    OBJ_EVENT_GFX_SINNOH_F_DECORATING,

    // Hoenn outfit, female (costume system)
    OBJ_EVENT_GFX_HOENN_F_NORMAL,
    OBJ_EVENT_GFX_HOENN_F_MACH_BIKE,
    OBJ_EVENT_GFX_HOENN_F_ACRO_BIKE,
    OBJ_EVENT_GFX_HOENN_F_SURFING,
    OBJ_EVENT_GFX_HOENN_F_UNDERWATER,
    OBJ_EVENT_GFX_HOENN_F_FIELD_MOVE,
    OBJ_EVENT_GFX_HOENN_F_FISHING,
    ...
    OBJ_EVENT_GFX_TEAM_ROCKET_F_NORMAL,
    OBJ_EVENT_GFX_TEAM_ROCKET_F_MACH_BIKE,
    OBJ_EVENT_GFX_TEAM_ROCKET_F_ACRO_BIKE,
    OBJ_EVENT_GFX_TEAM_ROCKET_F_SURFING,
    OBJ_EVENT_GFX_TEAM_ROCKET_F_FIELD_MOVE,
    OBJ_EVENT_GFX_TEAM_ROCKET_F_FISHING,
    OBJ_EVENT_GFX_TEAM_ROCKET_F_DECORATING,

    // Anime outfit, male (costume system)
    OBJ_EVENT_GFX_ANIME_M_NORMAL,
    OBJ_EVENT_GFX_ANIME_M_MACH_BIKE,
    OBJ_EVENT_GFX_ANIME_M_ACRO_BIKE,
    OBJ_EVENT_GFX_ANIME_M_SURFING,
    OBJ_EVENT_GFX_ANIME_M_UNDERWATER,
    OBJ_EVENT_GFX_ANIME_M_FIELD_MOVE,
    OBJ_EVENT_GFX_ANIME_M_FISHING,
    OBJ_EVENT_GFX_ANIME_M_DECORATING,

    // Team Magma outfit, male (costume system)
    OBJ_EVENT_GFX_TEAM_MAGMA_M_NORMAL,
    OBJ_EVENT_GFX_TEAM_MAGMA_M_MACH_BIKE,
    OBJ_EVENT_GFX_TEAM_MAGMA_M_ACRO_BIKE,
    OBJ_EVENT_GFX_TEAM_MAGMA_M_SURFING,
    OBJ_EVENT_GFX_TEAM_MAGMA_M_UNDERWATER,
    OBJ_EVENT_GFX_TEAM_MAGMA_M_FIELD_MOVE,
    OBJ_EVENT_GFX_TEAM_MAGMA_M_FISHING,
    OBJ_EVENT_GFX_TEAM_MAGMA_M_WATERING,
    OBJ_EVENT_GFX_TEAM_MAGMA_M_DECORATING,

    // Team Magma outfit, female (costume system)
    OBJ_EVENT_GFX_TEAM_MAGMA_F_NORMAL,
    OBJ_EVENT_GFX_TEAM_MAGMA_F_MACH_BIKE,
    OBJ_EVENT_GFX_TEAM_MAGMA_F_ACRO_BIKE,
    OBJ_EVENT_GFX_TEAM_MAGMA_F_SURFING,
    OBJ_EVENT_GFX_TEAM_MAGMA_F_UNDERWATER,
    OBJ_EVENT_GFX_TEAM_MAGMA_F_FIELD_MOVE,
    OBJ_EVENT_GFX_TEAM_MAGMA_F_FISHING,
    OBJ_EVENT_GFX_TEAM_MAGMA_F_WATERING,
    OBJ_EVENT_GFX_TEAM_MAGMA_F_DECORATING,

    // Rival outfit, male (costume system)
    OBJ_EVENT_GFX_KANTO_RIVAL_M_NORMAL,
    OBJ_EVENT_GFX_KANTO_RIVAL_M_MACH_BIKE,
    OBJ_EVENT_GFX_KANTO_RIVAL_M_ACRO_BIKE,
    OBJ_EVENT_GFX_KANTO_RIVAL_M_SURFING,
    OBJ_EVENT_GFX_KANTO_RIVAL_M_UNDERWATER,
    OBJ_EVENT_GFX_KANTO_RIVAL_M_FIELD_MOVE,
    OBJ_EVENT_GFX_KANTO_RIVAL_M_FISHING,
    OBJ_EVENT_GFX_KANTO_RIVAL_M_DECORATING,
...
#define OBJ_EVENT_PAL_TAG_GOLD                     0x116C
#define OBJ_EVENT_PAL_TAG_HOENN                    0x116D
#define OBJ_EVENT_PAL_TAG_KANTO_M                  0x116E
#define OBJ_EVENT_PAL_TAG_KANTO_F                  0x116F
#define OBJ_EVENT_PAL_TAG_SINNOH                   0x1170
...
#define OBJ_EVENT_PAL_TAG_ANIME_M                  0x117D
#define OBJ_EVENT_PAL_TAG_TEAM_MAGMA_M             0x117E
#define OBJ_EVENT_PAL_TAG_TEAM_MAGMA_F             0x117F
#define OBJ_EVENT_PAL_TAG_KANTO_RIVAL_M                  0x1180
